...
public class GnuTraxGui extends JFrame {
  ...
  public void setTiles() {
    ...
    try {
      /* 60x60 gif */
      tiles[TraxBoard.NS] = new Tile(ImageIO.read(GnuTraxGui.class.getResource("images/medium/ns.gif")), TraxBoard.NS);
      tiles[TraxBoard.WE] = new Tile(ImageIO.read(GnuTraxGui.class.getResource("images/medium/we.gif")),
          TraxBoard.WE);
      tiles[TraxBoard.NW] = new Tile(ImageIO.read(GnuTraxGui.class.getResource("images/medium/nw.gif")),
          TraxBoard.NW);
      tiles[TraxBoard.NE] = new Tile(ImageIO.read(GnuTraxGui.class.getResource("images/medium/ne.gif")),
          TraxBoard.NE);
      tiles[TraxBoard.WS] = new Tile(ImageIO.read(GnuTraxGui.class.getResource("images/medium/ws.gif")),
          TraxBoard.WS);
      tiles[TraxBoard.SE] = new Tile(ImageIO.read(GnuTraxGui.class.getResource("images/medium/se.gif")),
          TraxBoard.SE);
      tiles[TraxBoard.INVALID] = new Tile(
          ImageIO.read(GnuTraxGui.class.getResource("images/medium/invalid.gif")), TraxBoard.INVALID);
      tiles[TraxBoard.EMPTY] = new Tile(
          ImageIO.read(GnuTraxGui.class.getResource("images/medium/blank.gif")), TraxBoard.EMPTY);
    } catch (IOException e) {
      e.printStackTrace();
    }
    newBoard();
